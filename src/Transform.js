// Modified by Carl Hewett for GEngine
...
Transform.prototype.save = function() {
  this.ms[this.ms.length] = this.m;
};

Transform.prototype.restore = function() {
  var stackLength = this.ms.length;
  ...
  this.m = this.ms[stackLength-1]; // Restore last save
  this.ms.splice(stackLength-1, 1);
};
